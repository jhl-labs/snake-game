...
PROMPT="./buggy 실행 시 장바구니 이름이 깨지거나 데이터가 손상돼. gdb로 원인을 분석하고 main.c의 버그를 수정해줘. 수정 후 다시 빌드해서 정상 동작하는지 확인해줘."
echo "프롬프트: $PROMPT"
echo
...
echo
echo "학습 포인트:"
echo "  - watch 명령어로 변수 변경 감시"
echo "  - x/Nw &var 로 메모리 직접 확인"
echo "  - 배열 인덱스 범위 검사의 중요성"
echo
