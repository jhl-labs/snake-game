...
<Meta title="Chapters/07. MCP/7.1 MCP 소개 및 활용" />

# 7.1 MCP (Model Context Protocol) 소개 및 활용
...
<ChapterNav
  prevLink="?path=/docs/chapters-06-subagent-skills-6-2-agent-skills--docs"
  prevTitle="6.2 Agent Skills"
  nextLink="?path=/docs/chapters-07-mcp-7-2-mcp-실전-활용-사례--docs"
  nextTitle="7.2 MCP 실전 활용 사례"
/>
