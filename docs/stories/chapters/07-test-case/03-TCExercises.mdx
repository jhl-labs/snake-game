...
<Meta title="Chapters/07. Test Case 작성 실습/7.3 TC 실습" />
...
<Placeholder type="video" alt="Agent가 snake_init 테스트를 생성하는 과정" />
...
<Placeholder type="image" alt="통합 테스트 코드가 생성된 모습" />
...
<Placeholder type="video" alt="Agent가 테스트 코드를 리뷰하고 개선점을 제안하는 과정" />
...
<Placeholder type="image" alt="테스트 실행 결과 - 모든 테스트 통과 메시지" />
